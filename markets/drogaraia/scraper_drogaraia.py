...
Index    : drogaraia-rd-product-index  (search-only key; app A7RGTHYMDQ)
...
Usage:
    ...
    python -m markets.drogaraia.scraper_drogaraia --limit 500
"""
...
ALGOLIA_INDEX = "drogaraia-rd-product-index"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Scrape Drogaria Raia (Algolia) -> PostgreSQL")
